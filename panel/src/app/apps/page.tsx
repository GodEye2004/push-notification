  ...
  const apps = [
    {
      ...
      status: "Active",
      devices:
        activeClients.filter((c) => c.platform === "android").length || "0",
    ...
    },
    {
      ...
      platform: "iOS",
      status: "Active",
      devices: activeClients.filter((c) => c.platform === "ios").length || "0",
      lastSent: "1 day ago",
    },
    {
      id: 3,
      ...
      platform: "Web",
      status: "Paused",
      devices: activeClients.filter((c) => c.platform === "web").length || "0",
      lastSent: "5 days ago",
    },
  ];
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/5">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <div
                      className={`w-2 h-2 rounded-full ${app.status === "Active" ? "bg-green-500" : "bg-orange-500"}`}
                    />
